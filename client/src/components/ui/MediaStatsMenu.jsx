...
const MediaStatsMenu = ({ videoStats }) => {
  ...
  return (
    <div className={`fixed sm:absolute top-1/2 sm:top-20 left-1/2 sm:left-auto right-auto sm:right-4 -translate-x-1/2 sm:translate-x-0 -translate-y-1/2 sm:translate-y-0 backdrop-blur-xl p-4 rounded-xl shadow-2xl z-[20000] w-[90vw] sm:w-64 max-h-[85vh] overflow-y-auto animate-in fade-in zoom-in-95 sm:slide-in-from-right-4 pointer-events-none border ${getPanelTheme(appTheme)}`}>
